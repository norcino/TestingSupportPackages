...
namespace AnonymousData.Tests
{
    ...
    public class AnyTests
    {
        ...
        {
            Assert.AreEqual(lenght, Any.String(prefix, lenght).Length);
        }
        ...
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => Any.String("", length), "length must be greater than zero");
        }
        ...
        {
            Assert.AreEqual(length, Any.String("", length).Length);
        }
    }
}